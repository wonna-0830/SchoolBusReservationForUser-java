...
public class gyonea extends AppCompatActivity {

    private FloatingActionButton fab;
    private FirebaseFirestore mFirebasestore;
    private static final String TAG = "gyonea";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 드롭다운 메뉴에 표시할 항목들 배열
        String[] item_time = new String[]{"시간을 선택하세요", "08:30", "08:35", "08:40", "08:55", "09:00"
                , "09:30", "09:40", "09:50", "10:00", "10:10", "10:20", "10:30"
                , "10:40", "10:50", "11:00"};
        String[] item_place = new String[]{"장소를 선택하세요", "정문", "B1", "C7", "C13", "D6", "A2(건너편)"};
            ...
            public void onClick(View view) {
                ...
                if (currentUser != null) {
                    ...
                    if (selectedTimePosition != 0 && selectedPlacePosition != 0) {
                        ...
                        Intent intent = new Intent(gyonea.this, selectbuslist.class);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_1) {
                    ...
                    startActivity(new Intent(gyonea.this, selectbuslist.class));
                    finish();
                    return true;
                    ...
                    if (myAuth != null) {
                        ...
                        startActivity(new Intent(gyonea.this, login.class));
                        finish();
                        return true;
