...
public class ansim_sawel extends AppCompatActivity {

    private FloatingActionButton fab;
    private static final String TAG = "ansim_sawel";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 드롭다운 메뉴에 표시할 항목들 배열
        String[] item_time = new String[]{"시간을 선택하세요", "16:00", "16:15", "16:30", "16:40", "16:50"
                , "17:00", "17:15", "17:30"};

        String[] item_place = new String[]{"장소를 선택하세요", "A2(건너편)", "안심역", "사월역"};
            ...
            public void onClick(View view) {
                ...
                if (currentUser != null) {
                    ...
                    if (selectedTimePosition != 0 && selectedPlacePosition != 0) {
                        ...
                        String selectedRoute = "학교->안심역->사월역";
                        ...
                        Intent intent = new Intent(ansim_sawel.this, selectbuslist.class);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_1) {
                    ...
                    startActivity(new Intent(ansim_sawel.this, selectbuslist.class));
                    finish();
                    return true;
                    ...
                    if (myAuth != null) {
                        ...
                        startActivity(new Intent(ansim_sawel.this, login.class));
                        finish();
                        return true;
